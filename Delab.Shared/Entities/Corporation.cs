...
public class Corporation
{
    ...
    //TODO: Cambia de ruta para Imagenes
    // Propiedad virtual de acceso a la imagen
    public string ImageFullPath => Imagen == string.Empty || Imagen == null
        ? $"https://localhost:7254/Images/NoImage.png"
        : $"https://localhost:7254/Images/ImgCorporation/{Imagen}";
