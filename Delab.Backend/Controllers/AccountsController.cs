...
public class AccountsController : ControllerBase
{
    ...
    public async Task<ActionResult> Login([FromBody] LoginDTO modelo)
    {
        ...
        string ImagenDefault = $"https://localhost:7254/Images/NoImage.png";
        string BaseUrl = $"https://localhost:7254/Images/";
    ...
    private TokenDTO BuildToken(User user, string imgUsuario)
    {
        ...
        if (RolUsuario != null)
        {
            //TODO: Cambio de Path para Imagenes
            NomCompa = "Digitales";
            LogoCompa = $"https://localhost:7254/Images/NexxtplanetLLC.png";
            imgUsuario = $"https://localhost:7254/Images/NexxtplanetLLC.png";
        }
        else
        {
